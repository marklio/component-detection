...
namespace Microsoft.ComponentDetection.Common
{
    ...
    public class ComponentStreamEnumerableFactory : IComponentStreamEnumerableFactory
    {
        ...
        {
            var enumerable = new SafeFileEnumerable(directory, searchPatterns, Logger, PathUtilityService, directoryExclusionPredicate, recursivelyScanDirectories);
        ...
        {
            var enumerable = new SafeFileEnumerable(directory, fileMatchingPredicate, Logger, PathUtilityService, directoryExclusionPredicate, recursivelyScanDirectories);
            return new ComponentStreamEnumerable(enumerable, Logger);
        }
    }
}
