...
namespace Microsoft.ComponentDetection.Detectors.Npm
{
    ...
    public class NpmComponentDetectorWithRoots : FileComponentDetector
    {
        ...
        protected override async Task OnFileFound(ProcessRequest processRequest, IDictionary<string, string> detectorArgs)
        {
            ...
            var packageJsonComponentStream = ComponentStreamEnumerableFactory.GetComponentStreams(new FileInfo(file.Location).Directory, packageJsonPattern, (name, directoryName) => false, false);
                    ...
                    processRequest =>
                {
                    ...
                    do
                    {
                        ...
                        if (currentDir == null)
                        {
                            ...
                            var skippedFolder = SkippedFolders.FirstOrDefault(folder => item.Location.Contains(folder));
