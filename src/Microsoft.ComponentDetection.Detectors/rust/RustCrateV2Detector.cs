    ...
    public class RustCrateV2Detector : FileComponentDetector
    {
        ...
        protected override Task OnFileFound(ProcessRequest processRequest, IDictionary<string, string> detectorArgs)
        {
            ...
            try
            {
                ...
                var cargoTomlComponentStream = ComponentStreamEnumerableFactory.GetComponentStreams(lockFileInfo.Directory, new List<string> { RustCrateUtilities.CargoTomlSearchPattern }, (name, directoryName) => false, recursivelyScanDirectories: false);
                ...
                if (expectedWorkspaceTomlCount > 0)
                {
                    ...
                    var cargoTomlWorkspaceComponentStreams = ComponentStreamEnumerableFactory.GetComponentStreams(
