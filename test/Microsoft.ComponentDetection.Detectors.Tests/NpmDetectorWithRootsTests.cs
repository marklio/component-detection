...
namespace Microsoft.ComponentDetection.Detectors.Tests
{
    ...
    public class NpmDetectorWithRootsTests
    {
        ...
        {
            var lockFileLocation = Path.Combine(Path.GetTempPath(), Path.Combine("belowLerna", packageLockJsonFileName));
            var packageJsonFileLocation = Path.Combine(Path.GetTempPath(), Path.Combine("belowLerna", packageJsonFileName));
        ...
        {
            var packageJsonComponentPath = Path.Combine(Path.GetTempPath(), packageLockJsonFileName);
        ...
        public async Task TestNpmDetector_ShrinkwrapLockReturnsValid()
        {
            ...
            var packageJsonComponentPath = Path.Combine(Path.GetTempPath(), packageJsonFileName);
        ...
        public async Task TestNpmDetector_IgnoresPackageLocksInSubFolders()
        {
            ...
            var packageLockUnderNodeModules = Path.Combine(pathRoot, Path.Combine("node_modules", packageLockJsonFileName));
            var packageJsonUnderNodeModules = Path.Combine(pathRoot, Path.Combine("node_modules", packageJsonFileName));
